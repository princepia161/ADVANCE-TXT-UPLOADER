...
OWNER_ID = 890749443 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [890749443]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1003646612944,-1002663510614]  # Add more channel IDs here
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..z4U0cH4QGznbGuKQ8LhUo-8RuR5SohiIK3eT7bD3HzzSoYjAsnP6-CNbTkxLidqT'}).json()['url']                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
